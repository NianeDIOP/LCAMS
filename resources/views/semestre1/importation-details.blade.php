        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('semestre1.importation') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    @if($import->status === 'terminé')
                        <div class="mt-4">
                            <form method="POST" action="{{ route('semestre1.delete-import', $import->id) }}" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette importation ? Cette action est irréversible.');">
                                @csrf
                                @method('DELETE')
