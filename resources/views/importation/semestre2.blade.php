...
@section('title', 'Importation Semestre 2')
...
@section('content')
<h1 class="page-title">
    <i class="fas fa-file-import me-2"></i>Importation des données - Semestre 2
</h1>
<p class="page-subtitle">Importez les fichiers Excel générés par PLANETE pour le deuxième semestre.</p>
...
<div class="row mb-4">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('importation.importer-s2') }}" method="POST" enctype="multipart/form-data" id="importForm">
                    @csrf
...
<div class="card">
    <div class="card-header header-success">
        <i class="fas fa-history me-2"></i>Historique des importations - Semestre 2
    </div>
    <div class="card-body">
